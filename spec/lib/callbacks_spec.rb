...
describe "Auditable#callbacks" do
  ...
  describe Plant do
    ...
    it "should create a new audit using callback" do
      plant.should_receive(:manually_update_audit) { plant.save_audit( {"action" => "dig", "modifications" => { "name" => "over ruled!" } } ) }
  ...
  describe Tree do
    ...
    it "should create a new audit using callback" do
      tree.should_receive(:manually_update_audit) { tree.save_audit( {"action" => "dig", "modifications" => { "name" => "over ruled!" } } ) }
  ...
  describe Kale do
    ...
    it "should have a valid audit to start with, include inherited attributes from Plant" do
      ...
      kale.audits.last.action.should == "create"
    end
